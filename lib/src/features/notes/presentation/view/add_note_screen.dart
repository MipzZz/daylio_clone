...
//     context.read<AddNoteBloc>().saveDate(date);
//   }
//
...
//     context.read<AddNoteBloc>().saveTime(timeOfDay);
//   }
//
//   void setTime() async {
...
//     context.read<AddNoteBloc>().saveMood(moodId);
//   }
//
//   @override
...
//   void initState() {
//     super.initState();
//     context.read<AddNoteBloc>().saveSelectedSleep(initialSelect.index);
//   }
//
//   void _onSleepSelect(GradeLabel? gradeLabel) {
//     if (gradeLabel == null) return;
//     context.read<AddNoteBloc>().saveSelectedSleep(gradeLabel.index);
//   }
//
//   void _onSleepDescriptionChanged(String v) {
//     context.read<AddNoteBloc>().saveSleepDescription(v);
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//   void initState() {
//     super.initState();
//     context.read<AddNoteBloc>().saveSelectedFood(initialSelect.index);
//   }
//
//   void _onFoodSelect(GradeLabel? gradeLabel) {
//     if (gradeLabel == null) return;
//     context.read<AddNoteBloc>().saveSelectedFood(gradeLabel.index);
//   }
//
//   void _onFoodDescriptionChanged(String v) {
//     context.read<AddNoteBloc>().saveFoodDescription(v);
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//     await context.read<AddNoteBloc>().saveNote();
