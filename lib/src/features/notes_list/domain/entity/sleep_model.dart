...
class SleepModel{
  ...
  SleepModel({required this.id, required this.title, required this.icon, required this.description, required this.color});

  SleepModel.empty() : this(id: 0, title: '', icon: '', description: '', color: Colors.white);
